...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	...
	if err = t.ExecuteTemplate(&templateBuffer, "body", msg.DataMap); err != nil {
		return "", nil
	}
...
func (m *Mail) inlineCSS(msg string) (string, error) {
	...
	preMailer, err := premailer.NewPremailerFromString(msg, &options)
	if err != nil {
		return "", nil
	}
...
func (m *Mail) getEncryption(protocol string) mail.Encryption {
	switch protocol {
	case "tls":
